          ...
          child: ScaleTransition(
            ...
            child: Column(
              children: [
                ...
                Text("Mind Cleanser", style: globalTextStyle(fontSize:36,color: AppColors.primary)),
                const SizedBox(height: 10),
                Text("Trauma. Crisis. Cravings.", style: globalTextStyle(fontSize:20,color: AppColors.primary)),
                const SizedBox(height: 20),
                Text("One Sound. No more Fear.", style: globalTextStyle(fontSize:16,color: AppColors.blackColor)),
